...
function ManageContent() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      let dataToSave = { ...formData, content_url: contentUrl, content_type: contentType };
...
<div className="action-buttons">
  {(userRole === 'teacher' || userRole === 'admin') && activeTab !== 'recycle-bin' && (
    <button
          ...
          <div className="item-content">
            ...
            {(userRole === 'teacher' || userRole === 'admin') && (
              <div className="quiz-actions">
                <div className="nav-icon icon-target center" onClick={() => handleQuizStart(quiz._id)}>
                ...
                <button onClick={() => handleManageQuestions(quiz)}>
                  Manage Questions
                </button>
              </div>
            )}
